...
const ArtistPublicPage = () => {
    ...
    const artworks = [
        { id: 1, name: "Masterpiece 1", category: "Digital", price: "$100", imageUrl: "https://via.placeholder.com/200" },
        { id: 2, name: "Sculpture 1", category: "Physical", price: "$250", imageUrl: "https://via.placeholder.com/200" },
        { id: 3, name: "Abstract Art", category: "Canvas", price: "$150", imageUrl: "https://via.placeholder.com/200" },
        { id: 4, name: "Digital Illustration", category: "Digital", price: "$80", imageUrl: "https://via.placeholder.com/200" },
    ];
                ...
                <div className="artworks-section">
                    ...
                    <div className="artwork-grid">
                        {filteredArtworks.map((artwork) => (
                            <div
                                key={artwork.id}
                                className={`artwork-card ${highlightedItem === artwork.id ? 'highlight' : ''}`}
                            >
